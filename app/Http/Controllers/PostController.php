...
class PostController extends Controller
{
    ...
    public function restore($id)
    {
        ...
        $post->restore();
         ...
         return redirect()->route('post.trashed')->with('success', 'Postingan berhasil direstore !');
    }
    ...
    public function kill($id)
    {
        ...
        $post->forceDelete();
         ...
         return redirect()->route('post.trashed')->with('success', 'Postingan berhasil dihapus permanen !');
    }
}
